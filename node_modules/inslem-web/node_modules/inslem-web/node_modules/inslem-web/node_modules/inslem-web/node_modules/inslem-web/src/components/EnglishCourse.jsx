...
const EnglishCourse = () => {
  ...
  return (
    <section id="ingles" className="py-14 sm:py-16 bg-white relative scroll-mt-20">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-8 sm:mb-10">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-inslem-blue-dark mb-3">
            ¡Aprende inglés con nosotros!
          </h2>
          <p className="text-gray-700 mt-2 max-w-2xl mx-auto text-base sm:text-lg">
        ...
        <div className="flex flex-wrap justify-center gap-4 sm:gap-6 mb-8 sm:mb-10 text-sm sm:text-base text-gray-600">
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8 max-w-4xl mx-auto">
          {englishCourses.modalities.map((modality) => (
            <div key={modality.id} className="bg-warm-light rounded-2xl border border-gray-200 overflow-hidden shadow-md hover:shadow-lg transition-shadow">
              {/* Card header bar */}
              <div className={`${modality.id === 'intensive' ? 'bg-inslem-blue' : 'bg-inslem-blue-dark'} px-5 sm:px-6 py-5`}>
                <div className="flex items-center justify-between flex-wrap gap-2">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <span className="text-white font-bold text-lg leading-tight">{modality.badge}</span>
                      <span className="text-blue-200 text-sm sm:text-base">{modality.subtitle}</span>
                    </div>
                  </div>
                  <span className="text-white font-semibold text-sm sm:text-base bg-white/20 px-3 py-1.5 rounded-full whitespace-nowrap">
              ...
              <div className="p-5 sm:p-6">
                ...
                <div className="bg-white rounded-xl p-5 border-2 border-gray-200 mb-6">
                  <div className="flex justify-between items-center pb-3 border-b border-gray-100">
                    <span className="text-gray-600 text-sm sm:text-base">Inscripción + materiales + camiseta</span>
                    <span className="text-xl sm:text-2xl font-extrabold text-inslem-blue-dark">RD${modality.enrollment.toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between items-center pt-3">
                    <span className="text-gray-600 text-sm sm:text-base font-medium">Mensualidad</span>
                    <span className="text-2xl sm:text-3xl font-extrabold text-inslem-orange">RD${modality.monthly.toLocaleString()}</span>
                  </div>
                </div>
                ...
                <a
                  ...
                  className="flex items-center justify-center gap-2 w-full bg-inslem-orange text-white font-bold px-5 py-4 rounded-lg shadow hover:bg-inslem-orange-hover transition text-base min-w-[200px] mx-auto"
                >
        ...
        {/* Note */}
        <p className="text-center text-base text-gray-500 mt-8 max-w-xl mx-auto">
          {englishCourses.note}
        </p>
      </div>
    </section>
