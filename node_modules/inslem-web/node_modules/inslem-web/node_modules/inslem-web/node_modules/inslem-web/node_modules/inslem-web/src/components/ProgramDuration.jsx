...
const ProgramDuration = () => {
  ...
  return (
    <section className="py-14 sm:py-16 bg-inslem-blue-dark relative overflow-hidden">
      {/* Subtle texture */}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-xl">
            <p className="text-gray-700 mb-6 text-lg sm:text-xl text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
              {/* First levels */}
              <div className="flex-1 bg-inslem-blue-soft rounded-xl p-5 sm:p-6 border border-inslem-blue/10 text-center">
                ...
                <div className="text-sm sm:text-base font-semibold text-inslem-blue-dark uppercase tracking-wide mb-1">
                  {firstLevels.label}
                </div>
                <div className="text-inslem-orange font-bold text-lg sm:text-xl">
              ...
              {/* Last levels */}
              <div className="flex-1 bg-inslem-teal-muted rounded-xl p-5 sm:p-6 border border-inslem-teal/10 text-center">
                ...
                <div className="text-inslem-teal font-bold text-lg sm:text-xl">
                  {lastLevels.duration}
                </div>
                <div className="mt-3 flex justify-center gap-1.5">
