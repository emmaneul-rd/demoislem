...
const Languages = () => {
  return (
    <section id="idiomas" className="py-14 sm:py-16 bg-inslem-blue-soft relative scroll-mt-20">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {languages.map((lang, index) => (
            <div key={index} className="bg-white rounded-xl p-6 sm:p-7 shadow-md border border-gray-100 flex flex-col items-start text-left h-full hover:shadow-lg transition-shadow group">
              {/* Icon — blue with turquoise hover effect */}
              <div className="w-14 h-14 rounded-xl bg-inslem-blue flex items-center justify-center mb-5 shadow-sm group-hover:bg-inslem-teal transition-colors">
                <i className={`fas ${lang.icon} text-white text-lg`}></i>
              </div>

              {/* Content */}
              <h3 className="text-xl font-bold text-inslem-blue-dark mb-2">{lang.name}</h3>
              <p className="text-gray-600 text-base mb-6 leading-relaxed flex-1">{lang.description}</p>
              ...
              <div className="pt-5 border-t border-gray-100 w-full">
                <a
                  ...
                  className="inline-flex items-center gap-2 text-inslem-teal text-base font-semibold hover:text-inslem-teal-light transition-colors"
                >
                  {lang.ctaText}
