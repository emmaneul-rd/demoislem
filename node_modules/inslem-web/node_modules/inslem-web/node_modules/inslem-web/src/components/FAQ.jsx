...
const FAQ = () => {
  ...
  return (
    <section id="faq" className="py-14 sm:py-16 bg-warm-light relative scroll-mt-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="max-w-2xl mx-auto space-y-3">
          {faqItems.map((item, index) => (
            <div key={index} className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
              ...
              >
                <span className="font-semibold text-inslem-blue-dark text-base sm:text-lg pr-4">
                  {item.question}
                </span>
        ...
        <div className="text-center mt-10">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-inslem-orange text-white font-semibold px-6 py-3 rounded-lg shadow-sm hover:bg-inslem-orange-hover transition text-base"
          >
