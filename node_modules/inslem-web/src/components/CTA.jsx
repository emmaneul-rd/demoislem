...
const CTA = () => {
  ...
  return (
    <section id="contacto" className="py-16 sm:py-20 bg-inslem-blue-dark relative overflow-hidden scroll-mt-20">
      {/* Texture */}
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center relative z-10">
        ...
        <p className="text-lg sm:text-xl lg:text-2xl text-blue-100 mb-8 max-w-xl mx-auto leading-relaxed">
        ...
        <p className="text-blue-200 text-base mt-5">Respuesta rápida · Te orientamos sin compromiso</p>
        ...
        <div className="mt-8 pt-6 border-t border-white/10">
          <p className="text-blue-200 text-base mb-3">O comunícate con nosotros por:</p>
          <div className="flex flex-wrap items-center justify-center gap-5 text-base">
            <a href={`tel:${businessInfo.phone}`} className="flex items-center gap-2 text-blue-200 hover:text-white transition">
              <i className="fas fa-phone text-inslem-teal-light text-sm"></i>
              {businessInfo.phone}
            </a>
            ...
            <a href={`mailto:${businessInfo.email}`} className="flex items-center gap-2 text-blue-200 hover:text-white transition">
              <i className="fas fa-envelope text-inslem-teal-light text-sm"></i>
              {businessInfo.email}
            </a>
          </div>
        </div>
